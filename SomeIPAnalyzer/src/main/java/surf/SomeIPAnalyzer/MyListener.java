		...
		*/
		...
		public void sendIDMEF(String classification, int srcIP, int dstIP){
			try {						
				...
				String src = String.valueOf(srcIPTEXT.getHostAddress());
				String trg = String.valueOf(dstIPTEXT.getHostAddress());
			...
			String msg = "data=<IDMEF-Message><Alert messageid=\""+String.valueOf(this.counter)+"\"><CreateTime>2000-03-09T10:03:04.93464Z</CreateTime><Analyzer model=\"SOMEIP-Analyzer\"/><Target><Node><Address category=\"ipv4-addr\"><address>"+trg+"</address></Address></Node></Target><Source><Node><Address category=\"ipv4-addr\"><address>"+src+"</address></Address></Node></Source><Classification text=\""+classification+"\"></Classification></Alert></IDMEF-Message>";
