# -*- coding: utf-8 -*-
#
# SOME-IP_Analyzer documentation build configuration file, created by
...
sys.path.insert(0, os.path.abspath('../SomeIPAnalyzer'))
...
project = u'SOME-IP_Analyzer'
copyright = u'2016, TUM i8 SURF Team'
author = u'TUMi8 SURF Team'
...
htmlhelp_basename = 'SOME-IP_Analyzerdoc'
...
latex_documents = [
    (master_doc, 'SOME-IP_Analyzer.tex', u'SOME-IP\\_Analyzer Documentation',
     u'TUMi8 SURF Team', 'manual'),
]
...
man_pages = [
    (master_doc, 'some-ip_analyzer', u'SOME-IP_Analyzer Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'SOME-IP_Analyzer', u'SOME-IP_Analyzer Documentation',
     author, 'SOME-IP_Analyzer', 'One line description of project.',
     'Miscellaneous'),
]
